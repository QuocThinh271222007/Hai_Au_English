...
function showTeacherModal(teacher = null) {
    ...
    showModal(`
        ...
        <form id="teacher-form" class="space-y-4" style="max-height: 70vh; overflow-y: auto; padding-right: 8px;">
            ...
            <div>
                <label class="profile-form-label">URL ảnh đại diện</label>
                <input type="url" name="image_url" class="profile-form-input" value="${escapeHtml(teacher?.image_url || '')}" placeholder="https://...">
            </div>
            <div class="grid grid-cols-2 gap-4">
                <div>
                    <label class="flex items-center gap-2">
    ...
    document.getElementById('teacher-form').addEventListener('submit', async (e) => {
        ...
        try {
            const result = isEdit 
                ? await adminService.updateTeacher(data)
...
async function showNewEnrollmentModal() {
    // Load users and courses for dropdown
